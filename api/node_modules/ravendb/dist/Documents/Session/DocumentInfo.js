...
class DocumentInfo {
    static getNewDocumentInfo(document) {
        ...
        if (!metadata) {
            Exceptions_1.throwError("InvalidOperationException", "Document must have a metadata");
        }
        ...
        if (TypeUtil_1.TypeUtil.isNullOrUndefined(id) || typeof id !== "string") {
            Exceptions_1.throwError("InvalidOperationException", "Document must have an id");
        }
        ...
        if (TypeUtil_1.TypeUtil.isNullOrUndefined(changeVector) || typeof changeVector !== "string") {
            Exceptions_1.throwError("InvalidOperationException", "Document must have an changeVector");
        }
